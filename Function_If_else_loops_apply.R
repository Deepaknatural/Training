...
if (hours <10) {
  ...
  print('Wao!, IIM Sirmaur, you are doing well.Very Nice')
}
...
fruit <- list(Basket = c('Apple', 'Orange', 'Passion fruit', 'Banana'), 
              Money = c(10, 12, 15,63), purchase = FALSE)



for (xdfgsgfwr  in fruit) 
{ 
  print(xdfgsgfwr)
}
...
dt_s<- sapply(dt, above_ave)
dt_s

dt_l<- lapply(dt, above_ave)
dt_l
